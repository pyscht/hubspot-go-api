...
// checks if the CollectionResponseAssociatedIdForwardPaging type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionResponseAssociatedIdForwardPaging{}
...
func (o CollectionResponseAssociatedIdForwardPaging) ToMap() (map[string]interface{}, error) {
