...
// checks if the ActionFunction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionFunction{}
...
func (o ActionFunction) ToMap() (map[string]interface{}, error) {
