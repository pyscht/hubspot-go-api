...
// checks if the ExtensionActionDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtensionActionDefinition{}
...
func (o ExtensionActionDefinition) ToMap() (map[string]interface{}, error) {
